 ...
 */
final class Version20230712100231 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE quiz (id INT AUTO_INCREMENT NOT NULL, creator_id INT NOT NULL, difficulty_id INT NOT NULL, status_id INT NOT NULL, title VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, INDEX IDX_A412FA926BF700BD (status_id), INDEX IDX_A412FA9261220EA6 (creator_id), INDEX IDX_A412FA92FCFA9DAE (difficulty_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE quiz_theme (quiz_id INT NOT NULL, theme_id INT NOT NULL, INDEX IDX_6B069E88853CD175 (quiz_id), INDEX IDX_6B069E8859027487 (theme_id), PRIMARY KEY(quiz_id, theme_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
